"""
Day 3: Comprehensive Validation (Rolling Normalization)

Runs full validation across historical liquidation events using rolling normalization.
Same setup as Day 3, but with RollingStressCalculator instead of StressCalculator.
"""
...
def run_comprehensive_validation():
    ...
    print("="*100)
    print("DAY 3: COMPREHENSIVE VALIDATION (ROLLING NORMALIZATION)")
    print("="*100)
    print()
    ...
    # Initialize components (with rolling calculator)
    ...
    output_dir = Path('/home/ross/.openclaw/workspace/stop-hunt-detector/output/day3_rolling')
